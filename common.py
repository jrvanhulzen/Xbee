...
def rebuild_waves(samples, PHASECAL_4):
    ...
    temp_degrees = (tempAdc/1024.0*3300.0) / 20. # TMP37 calibrate this... measuring voltage on supply pin
...
def calculate_power(samples, board_voltage):
    ...
    vref = board_voltage / 1024.0
    ct4_scaling_factor = vref * 100.0 * accuracy_calibration['ct4']
...
def get_board_voltage():
    ...
    board_voltage = (avg_reading / 1024.0) * 3.307 * 2.0
    #print("board voltage ="+str(avg_reading))
    board_voltage = 3.307
